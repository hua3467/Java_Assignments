    ...
    public static ArrayList<Employee> generateEmployees(){
        ...
        for( int i = 0; i < 10; i++ ){
            ...
            switch (value) {
                ...
                case 1:
                    {
                        // if valur = 1, create a SalariedEmployee object salaried
                ...
                case 2:
                    {
                        // if valur = 2, create a CommissionEmployee object commission
                ...
                case 3:
                    {
                        // if valur = 3, create a BasePlusCommissionEmployee object basePlusComs
